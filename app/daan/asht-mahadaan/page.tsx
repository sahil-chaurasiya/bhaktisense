...
const daanItems = [
  ...
  },
  {
    ...
    name: "लोहा दान",
    icon: "⚙️",
    benefit: "शनि दोष निवारण, बाधा मुक्ति",
    detail: "लोहे का दान शनि देव की प्रसन्नता के लिए अत्यंत फलदायी माना गया है। जीवन में आने वाली बाधाओं और कठिनाइयों को दूर करने के लिए लोहे का दान किया जाता है।",
  ...
  },
  {
    ...
    name: "कपास दान",
    icon: "🌿",
    benefit: "वस्त्र एवं सुख-समृद्धि",
    detail: "कपास का दान करने से जीवन में सुख-सुविधाओं की प्राप्ति होती है। यह दान दूसरों को वस्त्र उपलब्ध कराने का पुण्य कार्य है।",
  ...
  },
  {
    ...
    name: "सप्तधान्य दान",
    icon: "🌾",
    benefit: "धन-धान्य एवं समृद्धि",
    detail: "सात प्रकार के अनाजों (गेहूं, चावल, चना, मूंग, उड़द, जौ, तिल) का दान अत्यंत पुण्यदायी माना गया है। इससे घर में अन्न और धन-धान्य की कमी नहीं होती।",
    color: "from-gray-800 to-gray-900",
  },
  {
    num: "०८",
...
function DaanAccordion({ item, index }: { item: typeof daanItems[0]; index: number }) {
  ...
  return (
    ...
    >
      <button onClick={() => setOpen(!open)} className="w-full flex items-center gap-4 p-5 text-left group">
        <span className="text-[#16a34a]/40 text-sm font-bold w-8 flex-shrink-0" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>{item.num}</span>
        <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center text-xl flex-shrink-0 shadow-md`}>{item.icon}</div>
        <div className="flex-1 min-w-0">
          <p className="font-bold text-[#111111] text-base group-hover:text-[#111111] transition-colors" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>{item.name}</p>
          <p className="text-xs text-[#16a34a] mt-0.5" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>✦ {item.benefit}</p>
        </div>
        <ChevronDown size={18} className={`text-[#16a34a] flex-shrink-0 transition-transform duration-300 ${open ? "rotate-180" : ""}`} />
      </button>
      <AnimatePresence initial={false}>
        {open && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }} className="overflow-hidden">
            <div className="px-5 pb-5 ml-[4.75rem] border-t border-gray-200 pt-4">
              <p className="text-[#111111]/70 text-sm leading-relaxed" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>{item.detail}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
...
export default function AshtMahadaanPage() {
  return (
    <main className="bg-[#f5f5f5]">
      ...
      <section className="relative min-h-[60vh] flex items-end overflow-hidden bg-[#111111]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[20rem] text-white/[0.03] font-black select-none leading-none pointer-events-none" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>दान</div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 pb-20 pt-40 w-full">
          <motion.div {...fadeUp(0)}>
            <div className="flex items-center gap-2 text-white/40 text-sm mb-6 flex-wrap">
              ...
              <span>/</span>
              <span className="text-gray-500" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>अष्ट महादान</span>
            </div>
            ...
            <p className="text-[#ffffff] text-xl font-semibold mb-4" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>आठ महान दान</p>
            <p className="text-white/60 max-w-2xl leading-relaxed" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>
              सनातन/हिन्दू धर्म में दान को बहुत ही महत्वपूर्ण बताया गया है। आप अष्ट महादान एक साथ भी कर सकते हैं, और आप अलग-अलग भी कर सकते हैं।
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <motion.div {...fadeUp()} className="mb-10">
                <p className="text-gray-500 text-sm font-semibold tracking-[0.3em] uppercase mb-3">— अष्ट महादान में शामिल —</p>
                <h2 className="text-3xl sm:text-4xl font-bold text-[#111111] mb-4" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>आठ वस्तुओं का विवरण</h2>
                <p className="text-[#111111]/60 leading-relaxed" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>प्रत्येक महादान का अपना अलग पुण्य-फल और महत्व है। किसी भी दान पर क्लिक करके विस्तृत जानकारी पढ़ें।</p>
              </motion.div>

              <div className="space-y-3">
                {daanItems.map((item, i) => <DaanAccordion key={item.num} item={item} index={i} />)}
              </div>
              ...
              <motion.div {...fadeUp(0.2)} className="mt-12 bg-[#111111] rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="space-y-4 text-white/65 text-sm leading-relaxed relative z-10" style={{fontFamily:"'Noto Sans Devanagari',sans-serif"}}>
                  <p><strong className="text-[#ffffff]">अग्नि पुराण</strong> के अनुसार अष्ट महादान में गाय, तिल, लोहा, स्वर्ण, कपास, नमक, सप्तधान्य और भूमि शामिल हैं।</p>
                  <p>शास्त्रों में कहा गया है — <em className="text-[#ffffff]">जीवन क्षणभंगुर है, लक्ष्मी चंचल है। धन होने पर दान करना ही उसकी शोभा है।</em></p>
                  <p>इन दानों को एक साथ करने पर अधिकतम पुण्यफल की प्राप्ति होती है, परन्तु अलग-अलग करने पर भी प्रत्येक दान का पृथक फल मिलता है।</p>
                </div>
              </motion.div>
            </div>
