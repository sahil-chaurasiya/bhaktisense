            ...
            {testimonials.map((t, i) => (
              <div key={i} className="swiper-slide">
                <div className="bg-white/5 border border-gray-200 rounded-2xl p-7 h-full relative group hover:border-gray-200 transition-all duration-300">
                  <div className="absolute top-5 right-6 text-6xl text-[#16a34a]/10 font-serif select-none">&ldquo;</div>
                  ...
                  <div className="flex items-center gap-4 pt-4 border-t border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-xs" style={{ fontFamily: "'Noto Sans Devanagari',sans-serif" }}>{t.city}</p>
                    </div>
                  </div>
                </div>
              </div>
